const
    ...
    {AddNewCourses,getAllCourses,deleteCourse,getALLtrainer,updataInfromationCOurses,getOneCourse, SearchCourse,getAllCoursesNgo,registerTrainee,UNRegisterTrainee,GetRegisteredTrainees} = require('../coursesRep/courseRepository.js'),
...
let pagesize=20;
  ...
  // });
  router.get('/trainer/ngos/:id_ngo',(req,res)=>{

    let id_ngo=req.params.id_ngo;
    getALLtrainer(id_ngo,(getAlltrainersFaild , getAlltrainerssuccssed)=>{
